...
const Reg = () => {
  ...
  return (
    <div>
        ...
        <Typography variant='h2' component="div" sx={{ fontWeight: 'bold', color: 'white' }}>Registration Form</Typography>
      </Box>
